...
if (isset($_POST['newsletter'])) {
    ...
    $email = mysqli_real_escape_string($con, strip_tags(trim($_POST["newsemail"])));
    ...
    if (!empty($email)) {
        ...
        if (!(mysqli_num_rows($res) > 0)) {
            ...
            mysqli_query($con, $sql);
            $_SESSION['success'] = 'You have been successfuly added into our newsletter. Thank You <span class="fa fa-smile-o"></span>';

        } else {

           $_SESSION['failure'] = 'Seems like the email entered already is in our newsletter list <span class="fa fa-frown-o"></span>';
       }

   } else {
    $_SESSION['failure'] = "Please enter an email address before submitting";
}
