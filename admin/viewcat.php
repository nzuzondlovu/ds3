				...
				<dl>
				  <dt class="sidebar-search">
						...
						Search Results
						 ...
						 $query="SELECT * FROM category WHERE `id`= $name LIMIT 1 ";
									...
									<tbody>';
										while ($row=mysqli_fetch_array($result)) {
											...
											<tr>
												...
												<td><a href="DeleteCat.php?id='.$row['id'].'" class="btn btn-primary">Delete Category</a>  <a href="EditCat.php?id='.$row['id'].'" class="btn btn-primary">Edit Category</a></td>"
