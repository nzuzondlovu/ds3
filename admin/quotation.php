...
if(isset($_POST['submit'])) {
    ...
    if( $model != '' && $accessory != '' && $technician != '' && $deposit != '' && $balance != '' && $total != '' && $status != '' && $description != '') {
        ...
        $sql = "INSERT INTO quotation(name, serial, model, accessory, technician, description, deposit, balance, total, status) 
        VALUES ('".$name."', '".$serial."', '".$model."', '".$accessory."', '".$technician."', '".$description."', '".$deposit."', '".$balance."', '".$total."', '".$status."')";
