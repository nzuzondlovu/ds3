							...
							<div class="col-md-offset-3 col-md-6">
								<form action="viewtech.php" method="POST">
									...
									if(isset($_POST['search']))
									{
										...
										$query="SELECT * FROM technician WHERE name LIKE '%".$name."%' OR surname LIKE '%".$name."%' OR email LIKE '%".$name."%' OR speciality LIKE '%".$name."%'";
												...
												<tbody>';
													while ($row=mysqli_fetch_array($result)) {
														...
														<tr>
															...
															<td class=" pull-right">
																<a href="edituser.php?id='.$row['id'].'" class="btn btn-primary">Edit Technician</a>
															</td>
														</tr>';
													}
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="pull-right">
									<a href="users.php" class="btn btn-success"> Add Technician</a>
								</div>
							</div>
						</div>
						<div class="table-responsive">
							...
							$sql = "SELECT * FROM technician ORDER BY id DESC LIMIT $start_from, $num_rec_per_page";
