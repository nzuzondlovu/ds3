                                        ...
                                        while ($row = mysqli_fetch_assoc($res)) {
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-thumbnail">
                                                    <a href="product.php?id='.$row['id'].'"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="img/product-thumb-2.jpg"></a>
                                                </td>
                                ...
                                <div class="cross-sells">
                                    ...
                                    <ul class="products">
                                        <li class="product">
                                            ...
                                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="22" rel="nofollow" href="product.php?id=">Select options</a>
                                        </li>
